@extends('layouts')
@section('content')
    <form id="productForm" action="{{ route('tas.store') }}" method="POST">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group form-group-default">
                            <label>Stok</label>
                            <input id="stok" type="number" name="stok" class="form-control" placeholder="masukan jumlah stok">
                        </div>
                    ...
                    <div class="card-action">
                        ...
                        <button class="btn btn-danger" type="button"
                            onclick="window.location.href='{{ route('modelProduk.index') }}';">Batal</button>
                    </div>
                </div>
            </div>
        </div>
